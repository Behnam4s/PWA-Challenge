...
import services from "../../../../constant/serviceTile";
              ...
              <Grid item xs={12}>
                  <Stack spacing={2} sx={{ backgroundColor: 'white', borderRadius: '10px', padding: '10px'}}>
                      ...
                      <Stack direction={'row'} justifyContent={{xs: 'space-between', md: 'center'}}>
                          <Button variant="contained" sx={messageButton}>
                                  {'ارسال پیام'}
                          </Button>
                          <Button
                              variant="contained"
                              sx={callButton}
                              startIcon={<Call sx={{ marginLeft: '10px', color: '#66B1E2', width: {xs:'15px', sm: '30px'}}} />}
                          >
                                  {'تماس امن'}
                          </Button>
                      </Stack>
